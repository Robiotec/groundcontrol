...
# Linux Platform
# ----------------------------------------------------------------------------
if(EXISTS "${CMAKE_SOURCE_DIR}/custom/resources/icons/medium_256.png")
    set(QGC_APPIMAGE_ICON_256_PATH "${CMAKE_SOURCE_DIR}/custom/resources/icons/medium_256.png" CACHE FILEPATH "AppImage 256x256 icon path" FORCE)
endif()
if(EXISTS "${CMAKE_SOURCE_DIR}/custom/resources/icons/logotipo.svg")
    set(QGC_APPIMAGE_ICON_SCALABLE_PATH "${CMAKE_SOURCE_DIR}/custom/resources/icons/logotipo.svg" CACHE FILEPATH "AppImage Icon SVG Path" FORCE)
endif()
...
if(EXISTS "${CMAKE_SOURCE_DIR}/custom/resources/icons/small_128.ico")
    set(QGC_WINDOWS_ICON_PATH "${CMAKE_SOURCE_DIR}/custom/resources/icons/small_128.ico" CACHE FILEPATH "Windows application icon" FORCE)
endif()
